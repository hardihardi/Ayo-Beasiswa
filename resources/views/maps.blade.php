...
<html>
  ...
  <body>
    <div id="locationField">
      <input id="searchInput" placeholder="Enter your address"
       type="text"></input>
    </div>
    ...
    <table id="address">
      ...
      <tr>
       ...
       <tr>
        <td class="label">Kecamatan/Distrik</td>
        <!-- Note: Selection of address components in this example is typical.
             You may need to adjust it for the locations relevant to your app. See
             https://developers.google.com/maps/documentation/javascript/examples/places-autocomplete-addressform
        -->
        <td class="wideField" colspan="3"><input class="field" id="administrative_area_level_3"
              disabled="true"></input></td>
      </tr>
       <tr>
        ...
        <!-- Note: Selection of address components in this example is typical.
             ...
             https://developers.google.com/maps/documentation/javascript/examples/places-autocomplete-addressform
        -->
        <td class="wideField" colspan="3"><input class="field" id="administrative_area_level_4"
              disabled="true"></input></td>
      </tr>
      <tr>
